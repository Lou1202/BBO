//
//  LineupValueTableViewController.swift
//  BBO
//
...
class LineupValueTableViewController: UITableViewController {
    
    static var teamLineupBatters = [Batter]()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            guard let cell = tableView.dequeueReusableCell(withIdentifier: "\(LineupValueTableViewCell.self)", for: indexPath) as? LineupValueTableViewCell else { fatalError("LineupValueTableViewCell failed")}
            let batter = LineupValueTableViewController.teamLineupBatters[indexPath.section]
            cell.setLevelButton(with: batter)
    ...
    override func tableView(_ tableView: UITableView, editingStyleForRowAt indexPath: IndexPath) -> UITableViewCell.EditingStyle {
        return indexPath.section == 9 ? .none : .delete
    }
